        ...
        <div className='h-screen flex items-center justify-center'>
            <div className='shadow p-6 flex flex-col w-2/7 rounded-2xl bg-white'>
                ...
                <form action={RegisterUSER}  className='flex flex-col'>
                    ...
                    <input type='text' name='fullname' className='mt-2 border border-gray-500 h-9 rounded-lg'/>
                    <p className='mt-3'>Email</p>
                    <input type='text' name='email' className='mt-2 border border-gray-500 h-9 rounded-lg'/>
                    <p className='mt-3'>Password</p>
                    <input type='password' name='password' className='mt-2 border border-gray-500 h-9 rounded-lg' />
